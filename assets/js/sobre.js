function mostrarOcultarPerfil(botaoClicado) {
	...
	if (botaoExpandido) {
		...
		botaoExpandido.parentNode.parentNode.querySelector(".corpo-perfil").style.display = "none";
	...
	if (botaoClicado != botaoExpandido) {
		...
		botaoClicado.parentNode.parentNode.querySelector(".corpo-perfil").style.display = "block";
	}
}
